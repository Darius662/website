...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('#icons01', { style: 'fade-in', speed: 1000, intensity: 2, threshold: 2, delay: 0, stagger: 125, staggerSelector: ':scope > li', replay: false });
		onvisible.add('#text02', { style: 'fade-in', speed: 1000, intensity: 2, threshold: 3, delay: 0, stagger: 125, staggerSelector: ':scope > *', replay: false });
		onvisible.add('#icons02', { style: 'fade-in', speed: 1000, intensity: 2, threshold: 2, delay: 0, stagger: 125, staggerSelector: ':scope > li', replay: false });
		onvisible.add('#buttons01', { style: 'fade-in', speed: 1000, intensity: 2, threshold: 3, delay: 500, stagger: 250, staggerSelector: ':scope > li', replay: false });
